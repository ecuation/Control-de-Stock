...
<div class="products-grid cf">
	...
	<textarea id="{$summary_products[map].id_sale}" class="common txtstuff txt-alert input-editable comments" placeholder="...">{$summary_products[map].note|html_entity_decode}</textarea>
