...
<div class="products-grid cf">
	...
	<div class="product-name">
		...
		<div class="oper-details cf">
           ...
           <!--  <input type="text" value="{$summary_products[map].note|html_entity_decode}" class="txt-alert input-editable" id="{$summary_products[map].id_sale}"> -->
            <textarea id="{$summary_products[map].id_sale}"  class="txt-alert input-editable">{$summary_products[map].note|html_entity_decode}</textarea>
